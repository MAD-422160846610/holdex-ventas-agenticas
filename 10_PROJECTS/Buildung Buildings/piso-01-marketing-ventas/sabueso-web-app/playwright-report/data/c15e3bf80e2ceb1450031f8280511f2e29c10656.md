...
- Name: auth.spec.ts >> [TC016] Credenciales inválidas son rechazadas y no redirigen al dashboard
- Location: e2e/auth.spec.ts:39:5
    ...
    - generic [ref=e48]:
      ...
      - tabpanel "Email" [ref=e52]:
        - generic [ref=e53]:
          ...
          - textbox "Email" [ref=e56]: invalido@ejemplo.com
