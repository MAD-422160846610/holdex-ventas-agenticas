...
updated: 2026-04-24
status: active
aliases: ['B5-vectorizacion-holdex-sales']
parent: [[piso-01-marketing-ventas]]
---

# B5 - Vectorización: Holdex Sales Division
...
En Holdex Sales, evitamos las imágenes de stock fotográficas (humanos sonriendo con auriculares, oficinas genéricas). Nuestros assets visuales son **puramente vectoriales, diagramáticos y basados en código (ASCII)**.
...
## Relacionado
- [[B4-logotipo-holdex-sales]]
- [[B6-sistema-iconos-holdex-sales]]
