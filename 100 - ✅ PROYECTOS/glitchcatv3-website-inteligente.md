...
## 🎯 Objetivos
1. El website debe poder recoger toda la información que se le da mediante un ADR (Arquitectural Decision Recording) y actualizar toda la información del website
...
## ✅ Próximos pasos
- [ ] Coordinar mediante Sprints todo el desarrollo
- [ ] Poder orquestrarlo con el desarrollo del website inteligente
